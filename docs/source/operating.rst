[thetssproject-3f10] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [thetssproject-3f10] container is NOT running**.

.. tip::
   You must have your [thetssproject-3f10] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypitss.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=45643  \-\-env VIPERVIZPORT=46485  \-\-env GITUSERNAME='smaurice101'  \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180'  \-\-env KAFKACLOUDUSERNAME='MUHRHBPKJYPROKBX'  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   http://localhost:46485/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:46485/viperlogs.html?topic=viperlogs&append=0
...
.. important::
   maadsdocker/thetssproject-3f10-amd64 (https://hub.docker.com/r/maadsdocker/thetssproject-3f10-amd64)
...
.. important::
   docker run -d -p 39727:39727 -p 47593:47593 -p 49805:49805 \-\-env TSS=0 \-\-env SOLUTIONNAME=thetssproject-3f10 \-\-env SOLUTIONDAG=solution_preprocessing_dag-thetssproject-3f10 \-\-env GITUSERNAME=smaurice101  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypitss.git \-\-env SOLUTIONEXTERNALPORT=39727  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=47593  \-\-env SOLUTIONVIPERVIZPORT=49805 \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env EXTERNALPORT=45643 \-\-env KAFKACLOUDUSERNAME='MUHRHBPKJYPROKBX'  \-\-env VIPERVIZPORT=46485 \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  maadsdocker/thetssproject-3f10-amd64
...
.. list-table::
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - maadsdocker/thetssproject-3f10-amd64
...
[thetssproject-3f10] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/smaurice101/raspberrypitss/tree/main/tml-airflow/dags/tml-solutions/thetssproject-3f10
...
.. important::
   https://thetssproject-3f10.readthedocs.io
...
.. important::
   solution_preprocessing_dag-thetssproject-3f10
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=39727, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=36027, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=33317, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=34115, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=45929, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=34425, HPDEHOST=127.0.1.1, HPDEPORT=44629, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=45477

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-8442-thetssproject-3f10,solution_preprocessing_dag-thetssproject-3f10, python-preprocess-911-thetssproject-3f10,solution_preprocessing_dag-thetssproject-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
